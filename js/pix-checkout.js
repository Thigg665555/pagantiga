...
function pegarParametrosUtm() {
  // Usa o que foi capturado logo no carregamento da página (ver <head>),
  // já que a URL pode ter sido limpa por outro script até aqui.
  return window.__pixUtmsCapturados || {};
}
